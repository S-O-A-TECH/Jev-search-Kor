...
export const Route = createFileRoute('/search')({
  ...
  head: ({ match }) => ({
    meta: [
      { title: match.search.q ? `${match.search.q} · Jev Search Kor` : 'Jev Search Kor — 한국어 검색' },
  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-5xl px-4 py-4">
        {!params.q.trim() && <p className="text-muted-foreground">검색어를 입력해 주세요.</p>}
            ...
            <div className="min-w-0">
              ...
              <Working
                ...
                actions={state.items.length > 0 && (
                  <div className="flex shrink-0 items-center gap-2 whitespace-nowrap text-xs" role="group" aria-label="검색 결과 정렬">
                    <button
